#!/bin/bash
# Gematchte Benchmarks Vire vs Rust vs C++ (best-of-3, optimiert). Korrektheit
# wird per Ausgabe-Vergleich mitgeprüft.
set -e
cd "$(dirname "$0")"
export LC_ALL=C
