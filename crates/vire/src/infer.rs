            ...
            Expr::Call { callee, args, .. } => {
                ...
                if let Expr::Ident(n, _) = callee.as_ref() {
                    ...
                    match n.as_str() {
                        ...
                        | "vk_mesh" | "vk_mesh_c" | "vk_mesh_shader" | "vk_draw" | "vk_draw_tex" | "vk_draw_tex2" | "vk_draw_buf" | "vk_draw_tex_buf" | "vk_render_ppm" | "vk_render3d" | "vk_resolution" | "vk_pipeline_depth" | "vk_motion" | "vk_gpu_count" | "vk_gpu_list" | "vk_gpu_select" | "vk_jitter"
